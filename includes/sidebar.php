<?php include("info.php");?>
		<div id="sidebar">
			<header>
				<a href="<?php echo "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']; ?>" accesskey="1"><img src="../img/logo-80.png" alt="Logo of Vladislav Altanov" width="129" height="120" /></a>
			...
			<footer>
				...
				<p>Vladislav Altanov &copy; 2014<br /> All rights reserved.</p>
			</footer>
		</div><!--End sidebar-->
